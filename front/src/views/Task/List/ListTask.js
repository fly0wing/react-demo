    ...
    render() {
        ...
        return (  <tr key={task.id}>
                ...
                <td style={{
                    ...
                    <Link className="btn btn-sm btn-primary" to={"/datasource/" + left.id}>
                        {left.name}</Link>
                    <br/>
                ...
                <td style={{
                    ...
                    <Link className="btn btn-sm btn-primary" to={"/datasource/" + right.id}>
                        {right.name}</Link>
                    <br/>
                    {tableNamePair.right}
                </td>
                ...
                <td>
                    <Link className="btn btn-sm btn-primary" to={"/task/" + task.id}>
                        <i className="fa fa-dot-circle-o"></i>update</Link>
                    <button className="btn btn-sm btn-primary" onClick={() => self.props.onStart(task.id)}>
